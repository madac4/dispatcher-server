...
export class OrderService {
  ...
  static calculateCosts(order: IOrder, routeInfo: RouteInfo): CostBreakdown {
  ...
  static async getRouteInfo(origin: string, destination: string): Promise<RouteInfo> {
  ...
  static validateVehicleCombination(truck: any, trailer: any): { isValid: boolean; errors: string[] } {
    const errors: string[] = []
