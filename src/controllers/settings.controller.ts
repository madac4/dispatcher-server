...
export const updateCompanyInfo = CatchAsyncErrors(
  async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    ...
    res
      .status(200)
      .json(SuccessResponse(updatedCompany.companyInfo, 'Company information updated'));
  }
);
...
export const updateCarrierNumbers = CatchAsyncErrors(
  async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    ...
    res
      .status(200)
      .json(SuccessResponse(updatedSettings.carrierNumbers, 'Carrier numbers updated'));
  }
);
