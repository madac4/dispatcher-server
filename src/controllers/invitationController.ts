...
export const createInvitation = CatchAsyncErrors(async (req: Request, res: Response, next: NextFunction) => {
  ...
  if (existingInvitation) {
    return next(new ErrorHandler('An active invitation already exists for this email', 409))
  }
...
export const removeInvitation = CatchAsyncErrors(async (req: Request, res: Response, next: NextFunction) => {
