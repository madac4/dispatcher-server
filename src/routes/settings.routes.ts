...
SettingsRoutes.post('/carrier-numbers/files', authMiddleware, upload.single('file'), uploadCarrierFile)
SettingsRoutes.get('/carrier-numbers/files', authMiddleware, getCarrierFiles)
SettingsRoutes.get('/carrier-numbers/files/:filename', authMiddleware, downloadFile)
SettingsRoutes.delete('/carrier-numbers/files/:filename', authMiddleware, deleteFile)
