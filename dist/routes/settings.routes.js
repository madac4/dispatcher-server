...
// Company info routes
SettingsRoutes.get('/company-info', authMiddleware_1.authMiddleware, settings_controller_1.getCompanySettings);
SettingsRoutes.put('/company-info', authMiddleware_1.authMiddleware, settings_controller_1.updateCompanyInfo);
// Carrier numbers routes
SettingsRoutes.get('/carrier-numbers', authMiddleware_1.authMiddleware, settings_controller_1.getCarrierNumbers);
SettingsRoutes.put('/carrier-numbers', authMiddleware_1.authMiddleware, settings_controller_1.updateCarrierNumbers);
